                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Category<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="<?=\yii\helpers\Url::to(['category/index']) ?>">List of categories</a></li>
                                        <li><a href="<?=\yii\helpers\Url::to(['category/create']) ?>">Add category</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a href="#">Items<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="<?=\yii\helpers\Url::to(['product/index']) ?>">List of items</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
